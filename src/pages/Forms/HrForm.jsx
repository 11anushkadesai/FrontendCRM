...
<h2 className="text-3xl font-bold text-center text-gray-800">Edit Hiring Team Details</h2>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div>
      ...
      <input
        ...
        onChange={(e) =>
          setUpdatedData({ ...updatedData, Hr_team_name: e.target.value })
        }
      />
    </div>
    <div>
      ...
      <input
        ...
        onChange={(e) =>
          setUpdatedData({ ...updatedData, Date_of_Contact: e.target.value })
        }
      />
    </div>
    <div>
      ...
      <input
        ...
        onChange={(e) =>
          setUpdatedData({ ...updatedData, Date_of_Next_Contact: e.target.value })
        }
      />
    </div>
    <div>
      <label className={labelClass}>Total Payment</label>
      <input
        type="text"
        ...
        onChange={(e) =>
          setUpdatedData({ ...updatedData, Total_payment: e.target.value })
        }
      />
    </div>
    <div>
      ...
      <select
        ...
        onChange={(e) =>
          setUpdatedData({ ...updatedData, Payment_received: e.target.value })
        }
      >
    ...
    <div>
      ...
      <input
        ...
        onChange={(e) =>
          setUpdatedData({ ...updatedData, Payment_period: e.target.value })
        }
      />
    </div>
    <div>
      ...
      <input
        ...
        onChange={(e) =>
          setUpdatedData({ ...updatedData, Replacement_period: e.target.value })
        }
      />
    </div>
  </div>
